...
equation
  ...
  connect(rad.heatPortRad, case900Template.gainRad) annotation(
    Line(points = {{-37.2, 8}, {-46, 8}, {-46, 4}, {-60, 4}}, color = {191, 0, 0}));
  connect(pump.port_a, rad.port_b) annotation(
    Line(points = {{0, -10}, {-30, -10}, {-30, 0}}, color = {0, 127, 255}));
  connect(pump.port_b, hea.port_a) annotation(
    Line(points = {{20, -10}, {40, -10}, {40, 30}, {20, 30}}, color = {0, 127, 255}));
  connect(bou.ports[1], pump.port_a) annotation(
    Line(points = {{-20, -30}, {0, -30}, {0, -10}}, color = {0, 127, 255}));
  connect(case900Template.TSensor, reaTRoo.u) annotation(
    Line(points = {{-59, 12}, {46, 12}, {46, 30}, {58, 30}}, color = {0, 0, 127}));
  connect(reaTRoo.y, TZone) annotation(
    Line(points = {{81, 30}, {96, 30}, {96, 0}, {110, 0}}, color = {0, 0, 127}));
  connect(reaQHea.y, Q) annotation(
    Line(points = {{81, 60}, {110, 60}}, color = {0, 0, 127}));
  connect(reaPPum.u, pump.P) annotation(
    Line(points = {{58, -30}, {24, -30}, {24, -19}, {21, -19}}, color = {0, 0, 127}));
  connect(hea.port_b, rad.port_a) annotation(
    Line(points = {{0, 30}, {-30, 30}, {-30, 20}}, color = {0, 127, 255}));
  connect(case900Template.TSensor, con.u) annotation(
    Line(points = {{-59, 12}, {-54, 12}, {-54, -40}, {-40, -40}, {-40, -70}, {-34, -70}}, color = {0, 0, 127}));
  connect(con.y, ovePum.u) annotation(
    Line(points = {{-11, -70}, {-2, -70}}, color = {0, 0, 127}));
  connect(realToInteger.y, pump.stage) annotation(
  ...
  connect(offSet.y, add.u1) annotation(
    Line(points = {{-159, -10}, {-156, -10}, {-156, -74}, {-152, -74}}, color = {0, 0, 127}));
  ...
  connect(oveTSetSup.y, hea.TSet) annotation(
    Line(points = {{-7, 80}, {26, 80}, {26, 38}, {22, 38}}, color = {0, 0, 127}));
  connect(ovePum.y, realToInteger.u) annotation(
    Line(points = {{21, -70}, {58, -70}}, color = {0, 0, 127}));
  connect(oveTSetCoo.y, con.uHigh) annotation(
    Line(points = {{-99, -50}, {-54, -50}, {-54, -74}, {-34, -74}}, color = {0, 0, 127}));
  connect(oveTSetHea.y, con.uLow) annotation(
    Line(points = {{-99, -80}, {-40, -80}, {-40, -78}, {-34, -78}}, color = {0, 0, 127}));
  connect(oveTSetHea.y, conPI.u_s) annotation(
